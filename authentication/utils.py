                    ...
                    <tr>
                        ...
                        <table role="presentation" style="width:100%;border-collapse:collapse;border:0;border-spacing:0;">
                            ...
                            <td style="padding:0 0 36px 0;color:#153643;">
                                ...
                                Thank You for joining PESO Web App. To continue your registration, click the button below:
                                </p>
                                <p style="margin:0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;text-align:center;">
                                <a href="{link}" style="background-color:#ee4c50;text-decoration:none;padding:10px;color:white;">Verify email address</a>
                                </p>
                            </td>
                            </tr>
                        </table>
...
def send_email(email,name, link):
    message = Mail(
    from_email='pesomalvar@gmail.com',
    to_emails="pesomalvar@gmail.com",
    subject='PESO Malvar',
    html_content=email_template(name, link))
    try:
